...
const blogPosts = [
  ...
  },
  {
    ...
    title: "Premium Filter Brands Review: 3M, Honeywell, and More",
  ...
  // Additional Cost Analysis posts
  {
    ...
    title: "Calculating ROI on Premium Air Filters: A Financial Analysis",
    excerpt: "Learn how to calculate the return on investment for premium air filters by considering energy savings, health benefits, and system longevity.",
    author: "David Park",
    date: "2024-01-23",
    category: "Cost Analysis",
    readTime: "10 min read",
  ...
  },
  {
    ...
    title: "HVAC Maintenance Cost Comparison: Premium vs. Budget Filters",
    excerpt: "Compare long-term maintenance costs between premium and budget filters to make informed financial decisions.",
    author: "Dr. Emily Rodriguez",
    date: "2024-01-08",
    category: "Cost Analysis",
    readTime: "11 min read",
